...
const Tradesdec = () => {
  ...
  return (
      ...
      <div className="container md:pt-2 max-w-[1140px] 2xl:max-w-[1320px] px-3 mx-auto">
        <h2 data-aos="zoom-in" className=" font-openSans font-bold md:text-5xl sm:text-4xl text-3xl md:leading-[60px] text-white text-center">
          Take the{" "}
          ...
          Trading
              ...
              <p data-aos="zoom-in" className="md:pt-7 pt-2 sm:text-base font-openSans text-center md:pb-14 pb-4 mb-1 text-[#CCCDCD] font-normal">In a matter of minutes, one of our AI mentors will contact you, No <span className="md:block"></span> Experience Required!</p>
              <div className="flex items-center flex-wrap justify-center md:flex-row flex-col-reverse -mx-3">
                  <div data-aos="fade-right" className="md:w-1/2 md-pt-0 pt-4 w-full px-3">
                       <div className="flex md:justify-start justify-center">
                           <div className='bg-gradient-to-br from-[#00FFE1] to-[#6E5DF6] rounded-lg p-[2px] max-w-[558px]'>
                            ...
                            <div className='flex items-center gap-1 p-4 bg-[#13262C] rounded-l-[4px]'>
                                <select name="" id="" defaultValue={+91} className='bg-transparent border-none rounded-[4px]  h-full outline-none text-white font-openSans sm:text-base text-sm appearance-none cursor-pointer w-[28px]'>
                  ...
                  <div data-aos="fade-left" className="md:w-1/2 flex md:justify-start justify-center w-full px-3">
