...
const Gpusec = () => {
  return (
    <div className=" relative overflow-x-clip z-[1] lg:py-64 md:py-40 sm:py-20 py-10">
            <div className="w-[346px] h-[346px] bg-ellipsegradient rounded-full absolute bottom-0 left-[-30%] z-[-1] blur-[200px]"></div>
      <div data-aos="fade-down" className="relative z-10 before:absolute before:top-[50%] before:left-0 after:-z-10 before:-z-10 before:rotate-180 before:right-[58%] before:h-[3px] before:bg-leftlinegradient after:absolute after:top-[50%] after:right-0 after:left-[58%] after:h-[3px] after:bg-rightlinegradient ">
      ...
      <div className="container max-w-[1140px] px-3 mx-auto">
        <div className="flex md:flex-row items-center lg:pt-20 md:pt-16 pt-6 pb-3 flex-wrap -mx-3 flex-col-reverse">
          <div className="md:w-7/12 md:pt-0 pt-4 px-3">
            <h2 data-aos="fade-right" className=" font-openSans md:text-start text-center font-bold md:text-4xl sm:text-3xl text-2xl text-white md:leading-[46.8px]">
